...
module ybracket_body()
{
	
	translate([0,0,-20]) cube([20,50,40]);
	translate([0-30,-20,-20]) cube([50,20,20]);
	// Z Screws
	%translate([3+13,10,10]) rotate([0,90+180,0])boltHole(5, length=35);
	%translate([3+13,10,-10]) rotate([0,90+180,0])boltHole(5, length=35);
	// Y Screws
	%translate([10,40,-17]) rotate([0,0,0])boltHole(5, length=55);
	%translate([10,20,-17]) rotate([0,0,0])boltHole(5, length=55);
	// X Screws
	%translate([10-30,-10,-17]) rotate([0,0,0])boltHole(5, length=55);
	%translate([35-30,-10,-17]) rotate([0,0,0])boltHole(5, length=35);
	
}

module ybracket_cuts()
{       // Z Screws
	translate([3+13,10,10]) rotate([0,90+180,0])boltHole(5, length=35);
	translate([3+13,10,-10]) rotate([0,90+180,0])boltHole(5, length=35);
        // Y Screws
...
{  
   ...
   %translate([25+rod_length-50,-1,35]) rotate([0,90,90]) vslot20x20(rod_length);
}
...
translate([15+rod_length,30,5]) ybracket();